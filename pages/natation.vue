<template>
  <div>
    ...
    <h3>Bienvenue sur la page dédiée à la Natation !</h3>

    <!-- Section pour Bourges -->
    <div>
      <h1>Natation - Bourges</h1>
      <div class="info">
        <p><strong>Responsable :</strong>Mr Vaukan </p>
        <p><strong>Jours et Horaires :</strong></p>
        <ul>
          <li>Jeudi : 13h30 - 14h30</li>
        </ul>
      </div>
      <div class="location">
        <p><strong>Lieu :</strong> Centre Nautique Raymond Boisdé, Place Pierre de Coubertin, 18000 Bourges</p>
...
export default {
  ...
  methods: {
    initMapBourges() {
      const mapBourges = L.map('map-bourges').setView([47.0920306, 2.3953502], 13);

      L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
        attribution: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
      }).addTo(mapBourges);

      L.marker([47.0920306, 2.3953502]).addTo(mapBourges)
