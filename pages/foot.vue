<template>
  <div>
    ...
    <h3>Bienvenue sur la page dédiée au Football !</h3>

    <!-- Section pour Bourges -->
    <div>
      <h1>Football - Bourges</h1>
      <div class="info">
        <p><strong>Responsables :</strong> Thibaut et Romain</p>
        <p><strong>Jours et Horaires :</strong></p>
        <ul>
          <li>Jeudi : 18h00 - 20h00</li>
        </ul>
      </div>
      <div class="location">
        <p><strong>Lieu :</strong> Stade des Bigarelles, 22 Avenue des Dumones, 18000 Bourges</p>
...
export default {
  ...
  methods: {
    initMapBourges() {
      const mapBourges = L.map('map-bourges').setView([47.0800416, 2.4271166], 13);

      L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
        attribution: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
      }).addTo(mapBourges);

      L.marker([47.0800416, 2.4271166]).addTo(mapBourges)
        .bindPopup("Stade des Bigarelles<br>22 Avenue des Dumones, 18000 Bourges")
        .openPopup();
    },
    initMapBlois() {
