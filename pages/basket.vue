<template>
  <div>
    ...
    <h3>Bienvenue sur la page dédiée au Basketball !</h3>

    <!-- Section pour Bourges -->
    <div>
      <h1>Basketball - Bourges</h1>
      <div class="info">
        <p><strong>Responsables :</strong> Hugo</p>
      ...
      <div class="location">
        <p><strong>Lieu :</strong> Gymnase Jean Moulin, Rue Jean Moulin, 18000 Bourges</p>
