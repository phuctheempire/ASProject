<template>
  <div>
    ...
    <h3>Bienvenue sur la page dédiée à l'Ultimate !</h3>

    <!-- Section pour Bourges -->
    <div>
      <h1>Ultimate - Bourges</h1>
      <div class="info">
        <p><strong>Responsables :</strong> Eva et Nolan</p>
        <p><strong>Jours et Horaires :</strong></p>
        <ul>
          <li>Jeudi : 13h30 - 15h30</li>
        </ul>
      </div>
      <div class="location">
        <p><strong>Lieu :</strong> Synthétique Gymnase Yves du manoir, 74 Rue de Turly, 18000 Bourges</p>
...
export default {
  ...
  methods: {
    initMapBourges() {
      const mapBourges = L.map('map-bourges').setView([47.0998228, 2.4178353], 13);

      L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
        attribution: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
      }).addTo(mapBourges);

      L.marker([47.0998228, 2.4178353]).addTo(mapBourges)
