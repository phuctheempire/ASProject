<template>
  <div>
    ...
    <h3>Bienvenue sur la page dédiée au HandBall !</h3>

    <!-- Section pour Bourges -->
    <div>
      <h1>HandBall - Bourges</h1>
      <div class="info">
        <p><strong>Responsables :</strong> Céleste et Thomas</p>
        <p><strong>Jours et Horaires :</strong></p>
        <ul>
          <li>Lundi : 20h15 - 22h00</li>
