<template>
  <div>
    ...
    <h3>Bienvenue sur la page dédiée au Cheerleading !</h3>

    <!-- Section pour Bourges -->
    <div>
      <h1>Cheerleading - Bourges</h1>
      <div class="info">
      ...
      <div class="location">
        <p><strong>Lieu :</strong> Gymnase Jean Brivot, Avenue Roland Garros, 18000 Bourges</p>
