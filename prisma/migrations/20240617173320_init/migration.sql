...
-- CreateTable
CREATE TABLE "SportAccount" (
    "id" TEXT NOT NULL PRIMARY KEY,
    "sportID" TEXT NOT NULL,
    "accountID" TEXT NOT NULL,
    CONSTRAINT "SportAccount_sportID_fkey" FOREIGN KEY ("sportID") REFERENCES "Sport" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "SportAccount_accountID_fkey" FOREIGN KEY ("accountID") REFERENCES "Account" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
-- CreateIndex
CREATE UNIQUE INDEX "SportAccount_accountID_key" ON "SportAccount"("accountID");

-- CreateIndex
CREATE UNIQUE INDEX "SportAccount_sportID_accountID_key" ON "SportAccount"("sportID", "accountID");
