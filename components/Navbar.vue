    ...
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      <div class=" hidden w-full md:block md:w-auto ml-auto" id="navbar-default">
        <ul v-if="!isMobile"
          ...
          <li>
            <NuxtLink to="/"
              class="block pl-3 pr-4 md:bg-transparent md:hover:text-purple-700 md:p-0 dark:text-white md:dark:text-purple-500"
...
.sidebar-link {
  ...
  color: white;
  padding-left: 8px; /* Ajoute un padding à gauche pour décaler le texte */
}
...
.md\\:button-shift-left-md {
  left: 20px; /* Adjust as needed for medium screens */
  top: 20px; /* Adjust as needed for medium screens */
}
